...
if __name__ == '__main__':
    ...
    # send player info
    player_info = PlayerInfoPacket()
    player_info.set_content('playerno', 12)
    player_info.set_content('name', 'player')
    player_info.set_content('username', 'user')
    player_info.set_content('score', 13)
    player_info.set_content('turns_alive', 14)
    player_info.set_content('is_alive', 0)
    player_info.set_content('gold', 15)
    player_info.set_content('percent_tax', 16)
    player_info.set_content('science', 17)
    player_info.set_content('luxury', 18)
    listener.send_packet(player_info)
